"""
This file contains the functional tests for the stocks blueprints
"""
...
def test_about_page_has_flashed_message(test_client):
    """
    GIVEN a Flask application
    WHEN the '/about' page is requested (GET)
...
#
#
# def test_post_add_stock_page_and_get_flashed_message(test_client):
#     """
#     GIVEN a Flask application
#     WHEN the '/add_stock' page is posted to (POST)
